...
const Project = () => {
  ...
  const projects = [
    {
      id: 1,
      title: "ResilientGrow - Digital Marketing Agency",
      description:
        "A comprehensive digital marketing platform with advanced analytics, client management, and automated campaign tools.",
      image: "/images/project/resilientgrow.webp",
    ...
    },
    {
      ...
      description:
        "Enterprise-level HR management solution with employee tracking, payroll automation, and performance analytics.",
      image: "/images/project/LTS.webp",
    ...
    },
    {
      ...
      description:
        "Full-service digital marketing agency website with portfolio showcase and client testimonials.",
      image: "/images/project/amcoderbits.webp",
    ...
    },
    {
      ...
      description:
        "Educational platform for coaching institute with course management and student portal.",
      image: "/images/project/lakshaya.webp",
      technologies: ["React", "Node.js", "MySQL", "JWT"],
      rating: 4.9,
      reviews: 203,
      link: "https://lakshaya.in",
    },
  ];
